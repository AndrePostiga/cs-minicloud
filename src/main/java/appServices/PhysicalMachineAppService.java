...
public interface PhysicalMachineAppService {
    ...
    PhysicalMachine CreatePhysicalMachine(long cpuId, long memoryInBytes, long ssdInBytes, long hdInBytes, OperationalSystemEnum sistemaOperational) throws NotFoundException;
